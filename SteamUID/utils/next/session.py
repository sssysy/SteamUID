...
async def get_account_session(steamid64: str) -> Optional[requests.Session]:
    """
    根据 steamid64 从数据库构建带有已授权 Cookie 的 requests.Session。
    """
...
async def get_valid_session(steamid64: str, auto_refresh: bool = True) -> Optional[requests.Session]:
    """
